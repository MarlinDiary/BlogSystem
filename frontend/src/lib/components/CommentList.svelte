<style>
    ...
    /* 只对第一和第二层级的评论添加悬停效果 */
    .space-y-4 > .timeline-container > article > .flex-1 > .comment__message,
    .space-y-4 > .timeline-container > article > .flex-1 > ul > li > article > .flex-1 > .comment__message {
      cursor: pointer;
      transition: opacity 0.2s ease-in-out;
    }
  
    .space-y-4 > .timeline-container > article > .flex-1 > .comment__message:hover,
    .space-y-4 > .timeline-container > article > .flex-1 > ul > li > article > .flex-1 > .comment__message:hover {
      opacity: 0.7;
    }
    ...
    /* 确保第三层评论没有任何交互效果 */
    .space-y-4 > .timeline-container > article > .flex-1 > ul > li > article > .flex-1 > ul > li > article > .flex-1 > .comment__message {
                ...
                <article class="relative flex gap-4 comment-item" class:hidden-comment={comment.visibility === 'hidden' && isAuthor}>
                  ...
                  <div class="flex-1 min-w-0 -mt-1">
                    ...
                    <button 
                      ...
                      on:click={(e) => handleReplyClick(e, comment.id)}
                      on:keydown={(e) => e.key === 'Enter' && handleReplyClick(e, comment.id)}
                      aria-label={$t('comment.replyTo', { username: comment.user.username })}
                    >
                              ...
                              <article class="relative flex gap-4 comment-item" class:hidden-comment={child.visibility === 'hidden' && isAuthor}>
                                ...
                                <div class="flex-1 min-w-0 -mt-1">
                                  ...
                                  <button 
                                    ...
                                    class="comment__message"
                                    on:click={(e) => handleReplyClick(e, child.id)}
                                    on:keydown={(e) => e.key === 'Enter' && handleReplyClick(e, child.id)}
                                    aria-label={$t('comment.replyTo', { username: child.user.username })}
                                  >
                                          ...
                                          {#if grandChild.visibility !== 'hidden' || isAuthor}
                                            <article class="relative flex gap-4 comment-item" class:hidden-comment={grandChild.visibility === 'hidden' && isAuthor}>
                                              ...
                                              <div class="flex-1 min-w-0 -mt-1">
                                                ...
                                                <button 
                                                  type="button"
                                                  class="comment__message third-level"
                                                  disabled
