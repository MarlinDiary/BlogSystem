...
<script>
  ...
  {#if mounted}
    <button
      ...
      on:click={openSearch}
    >
     <!-- Search icon with hover color change effect -->
      <svg class="h-6 w-6 stroke-zinc-900 transition group-hover:stroke-[#65a30d] dark:stroke-white dark:group-hover:stroke-[#65a30d]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
